    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        chemo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fm.beginTransaction().replace(R.id.fragment_container,(Fragment)new Chemotherapy()).commit();
      ...
      surgery.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View v) {
              FragmentManager fm =getFragmentManager();
              fm.beginTransaction().replace(R.id.fragment_container,(Fragment)new Surgery()).commit();
      ...
      radth.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View v) {
              FragmentManager fm =getFragmentManager();
              fm.beginTransaction().replace(R.id.fragment_container,(Fragment)new RadiationTherapy()).commit();
      ...
      hormoth.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View v) {
              FragmentManager fm =getFragmentManager();
              fm.beginTransaction().replace(R.id.fragment_container,(Fragment)new HormonalTherapy()).commit();
